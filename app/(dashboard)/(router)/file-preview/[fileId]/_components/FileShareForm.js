      ...
      {showPopup && (
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center z-50">
          ...
          <div className="fixed bottom-4 right-4 bg-white border border-gray-300 rounded-lg shadow-lg p-4 max-w-xs">
            <p className="text font-semibold mb-2  flex ">
              Due to technical reasons, the email will be sent to the admin instead. Please copy the link and share it. We are working on this issue and will fix it soon.
                </p>
            <p className="text font-semibold flex items-center">
                <FaFrownOpen className="inline-block mr-2" /> Sorry for the inconvenience
            </p>
        </div>
          </div>
      )}
