...
const RotateChevronDown = styled(ChevronDown)`
          ...
          {filteredFeatureFAQs.map((item, index) => (
            <div key={index}>
              <Question onClick={() => toggleAnswer(index)}>
                <QuestionContent>
                  {item.question}
                  <RotateChevronDown expanded={expanded === index} size={24} />
                </QuestionContent>
                <Answer expanded={expanded === index}>
          ...
          {filteredSupportFAQs.map((item, index) => (
            <div key={index}>
              ...
              >
                ...
                <Answer expanded={expanded === index + featureFAQs.length}>
                  <AnswerText>{item.answer}</AnswerText>
          ...
          {filteredPaymentFAQs.map((item, index) => (
            <div key={index}>
              ...
              >
                ...
                <Answer
                  expanded={
                    expanded === index + featureFAQs.length + supportFAQs.length
                  }
                >
                  <AnswerText>{item.answer}</AnswerText>
                </Answer>
